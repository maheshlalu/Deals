...
class CXCommentViewController: UIViewController,UITableViewDataSource,UITableViewDelegate{
    ...
    func customizeMainView() {
        ...
        self.ratingBtn = self.createButton(CGRect(x: self.writeBtn.frame.size.width+self.writeBtn.frame.origin.x, y: 0, width: btnsView.frame.size.width/2, height: 50), title: "OVERALL RATING", tag: 2, bgColor:UIColor.gray)
